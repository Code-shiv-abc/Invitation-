...
document.addEventListener('DOMContentLoaded', () => {
    ...
    rsvpButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            if (rsvpStatus === 'attending') {
                message = "I'm delighted to confirm my attendance for the wedding of Shiv & Priya!";
            } else {
                message = "I regret to inform you that I won't be able to attend the wedding of Shiv & Priya.";
            }
    ...
    calendarButtons.forEach(button => {
        button.addEventListener('click', (e) => {
            const title = encodeURIComponent(e.target.dataset.title);
            ...
            const location = encodeURIComponent(e.target.dataset.location);
